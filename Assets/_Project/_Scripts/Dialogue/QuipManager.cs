...
public class QuipManager : MonoBehaviour
{
    ...
    [SerializeField] private QuipTriggerType testTriggerType = QuipTriggerType.AmbientRandom;
    ...
    [ContextMenu("Test TryPlayQuip")]
    public void TestTryPlayQuip()
    {
        TryPlayQuip(testTriggerType);
    }
    ...
    public void TryPlayQuip(QuipTriggerType trigger)
    {
        ...
        var candidates = allQuips.Where(q =>
            (q.triggerType == trigger || q.triggerType == QuipTriggerType.AmbientRandom) &&
