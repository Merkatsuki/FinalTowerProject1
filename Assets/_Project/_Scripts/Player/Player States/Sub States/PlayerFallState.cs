...
namespace Momentum.States
{
    public class PlayerFallState : PlayerBaseState
    {
        ...
        public override void PhysicsUpdate()
        {
            ...
            // Clamp fall speed
            _playerReferences.PRB.linearVelocity = new Vector2(_playerReferences.PRB.linearVelocity.x, Mathf.Clamp(_playerReferences.PRB.linearVelocity.y, _playerData.MaxFallForce, float.MaxValue));
