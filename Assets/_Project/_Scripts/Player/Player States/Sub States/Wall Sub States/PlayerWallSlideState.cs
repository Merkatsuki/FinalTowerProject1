...
namespace Momentum.States 
{
	public class PlayerWallSlideState : PlayerWallState
	{
		...
		public override void LogicUpdate()
		{
            ...
            _playerReferences.PRB.linearVelocity = new Vector2(_playerReferences.PRB.linearVelocity.x, Mathf.SmoothDamp(_playerReferences.PRB.linearVelocity.y, -_playerData.SlideSpeed, ref _smoothDampVelTemp, _playerData.SlideSpeedSmoothTime));
